    ...
    render() {
            ...
            renderItem={item => (
                ...
                >
                    <List.Item.Meta
                        ...
                        description={<h>price: {(item[1].total).toLocaleString()} <br></br>time: {item[1].time}</h>}
        ...
        >
                ...
                <p style={{ textAlign: "center" }}>
                    {(this.state.selectDrawer != -1 ? this.state.allData[this.state.allData.findIndex(x => x[0] === this.state.selectDrawer)][1].total : "").toLocaleString()}</p>
